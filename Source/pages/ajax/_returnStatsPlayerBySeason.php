                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?= $totalLosses ?></div>
                                    <div>Défaites</div>
                                </div>
                            </div>
                        </div>
                ...
                {                 
                  ...
                  <?php foreach($champs as $champ):
                    if ($champ->id == key($arrayChampion)) {
                        ...
                        echo "<div id='imagePref'><img style='width: 80px; height: 80px;' src='http://ddragon.leagueoflegends.com/cdn/7.4.1/img/champion/" . $champName . ".png'". "title='". $champ->name . "'></div>";
                        break;
                    }
                  endforeach;
          ...
          <?php foreach($statsJoueurRanked->champions as $champPlayer): ?>
            <?php foreach($champs as $champ): ?>
              ...
              <?php if ($champ->id == $champPlayer->id && $champPlayer->id != 0) { ?>
                ...
                <div id="caseChamp">
                  <?php echo "<div id='imageChamp'><img style='opacity:0.5;' src='http://ddragon.leagueoflegends.com/cdn/7.4.1/img/champion/" . $champName . ".png'". "title='". $champ->name . "'></div>"; ?>
